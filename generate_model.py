...
epochs = 700
batch_size = 32
column_names = ["seq", "pSist", "pDiast", "qPA", "pulse", "respiratory_freq", "severity", "severity_class"]
...
#sns.pairplot(train_dataset[['severity', 'qPA', 'pulse', 'respiratory_freq']], diag_kind='kde')
